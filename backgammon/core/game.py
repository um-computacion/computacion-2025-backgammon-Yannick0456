...
class BackgammonGame:
    """
    Orquesta el flujo del juego (simplificado):
    - roll(): guarda valores de dados (4 si es doble)
    - apply_move(): valida distancia, mueve en Board, consume valor y alterna turno
    """
